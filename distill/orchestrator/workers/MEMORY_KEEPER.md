...
- Write JSONL to cold-notes (or `.agent/knowledge_distill.md` if deep-memory offline).
- Write project spirit / one-shot judgment to `.agent/handoff_letter.md` (not `distill/canon/HANDOFF_LETTER.md`).
